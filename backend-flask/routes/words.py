...
def load(app):
  ...
  def get_words():
    try:
      ...
      sort_by = request.args.get('sort_by', 'hindi')  # Default to sorting by 'hindi'
      order = request.args.get('order', 'asc')  # Default to ascending order

      # Validate sort_by and order
      valid_columns = ['hindi', 'transliteration', 'english', 'correct_count', 'wrong_count']
      ...
      cursor.execute(f'''
        SELECT w.id, w.hindi, w.transliteration, w.english, 
