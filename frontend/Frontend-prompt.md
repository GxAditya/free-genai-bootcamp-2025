...
We are building a Hindi language learning web-app which serves the following purposes:
- A portal to launch study activities
- to store, group and explore Hindi vocabulary
...
- Hindi: The Hindi word 
  ...
  - The Hindi word will be a link to the Words Show page
